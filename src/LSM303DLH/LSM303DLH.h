...
#define TWI_TWBR                   0x0C  // Set the bit rate to 400KHz
...
// Calibration values
// This was done using the Pololu Arduino sketch
// that produces the calibration values to use.
#define cal_x_min	137
#define cal_y_min	-280
#define cal_z_min	-687
#define cal_x_max	793
#define cal_y_max	96
